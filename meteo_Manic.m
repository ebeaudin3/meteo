% chargement des donnees Tmin, Tmax, Pluie, Neige Manic2
mois = 1;
fenetre = 27;
manic = 2;
...
fprintf('Manic %d %s %d-%d \n',manic,type,start_year(i_year),end_year(i_year));
...
for i=1:n
    ...
    ylabel(y)
    set(gca,'fontsize',14)
    titre = sprintf('Manic %d - %s%s',manic,upper(type(1)),lower(type(2:end)));
